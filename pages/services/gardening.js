  ...
  return (
    <main className="max-w-[1200px] mx-auto my-5 mb-24  px-3">
      <Head>
        ...
        <title> Shodex Garden Services - Gardening </title>
        <meta
          name="description"
          content="we offer our best in creating beautiful garden designs and development"
        />
        <meta
          name="keywords"
        ...
        <link
          rel="canonical"
          href="https://shodexgarden.com/services/gardening"
        />
        ...
        <meta
          property="og:url"
          content="https://shodexgarden.com/services/gardening"
        />
